...
{\bf (B)} An A549 fluorescent-reporter cell-line confirms that IFN expression is very rare in cells infected with our relatively pure viral stock.
...
Here we show statistics for the cells from the influenza-infected wildtype C57BL/6J mice, which were collected at 48 hours (two replicates) or 72 hours (1 replicate)---we do not show cells from the control mice.
...
{\includegraphics[width=0.8\textwidth]{figures/IFN_stochastic/SteuermanReanalysis/plots/p_mRNA_counts.pdf}}
\label{figsupp:mice}
...
\centerline{\jdbcomment{FIGURE 2 HERE}}
...
{\includegraphics[height=0.95\textheight]{figures/single_cell_figures/p_genotypes_by_ifn.pdf}}
\label{figsupp:genotypes_by_ifn}

\figdata{A CSV file giving the genotypes is in \texttt{figures/single_cell_figures/genotypes.csv}.}
