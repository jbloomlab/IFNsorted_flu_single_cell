...
\caption{
{\bf Details about the reporter cell lines (\FIG{IFNrare}A) to identify IFN+ cells.}
{\bf (A)}
...
\caption{
{\bf Details about PacBio sequencing.}
{\bf (A)}
...
{\bf An HTML rendering of the Jupyter notebook that analyzes the PacBio data to call the viral sequences in infected cells.}
...
{\bf An HTML rendering of the Jupyter notebook that analyzes the annotated cell-gene matrix to generate the figures in this paper.}
