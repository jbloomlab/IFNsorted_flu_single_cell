...
From the number of human and canine transcriptomes, we estimate~\citep{bloom2018estimating} that $\approx$11\% of the captured cells are actually multiplets in which more than one cell was in an emulsion. 
...
{\bf (G)} Fraction of cellular mRNA from IFN across all cells, faceted by whether the cells are infected.
...
\figsupp[Expression of ISGs in single infected and un-infected cells.]
{
