...
\jdbcomment{Alistair writes this}
Wildtype and synonymously barcoded viruses in \FIGDATA[experiment]{virus_seqs}
...
\subsection{Computational analysis of single-cell transcriptomic and PacBio data}
\jdbcomment{Jesse writes this}
