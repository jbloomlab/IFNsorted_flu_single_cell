...
These CCSs retain the cell barcodes, and with sufficient sequencing depth we obtain CCSs from multiple unique copies of each viral gene in each cell.
Because most cells are infected by just one or two unique virions, we can therefore build a consensus of CCSs for each viral gene in each cell to determine the sequence(s) of the infecting virions.
