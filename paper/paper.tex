...
\caption{\jdbcomment{add caption}}
\label{fig:validation}

\figdata{Genbank plasmid maps for the mutant genes in this figure cloned into the pHW* bi-directional reverse genetics plasmid~\citep{hoffmann2000dna} are at \url{https://github.com/jbloomlab/IFNsorted_flu_single_cell/tree/master/paper/figures/FluVariantPlasmidMaps}}
...
At 48 to 72 hours post-transfection, we harvested the virus-containing supernatant, clarified this supernatant by centrifugation at 300$\times$g for 4 min, and stored aliquots of the clarified viral supernatant at -80$^{\circ}$C.
We then thawed an aliquot of each virus and titered by TCID50 as described above.
