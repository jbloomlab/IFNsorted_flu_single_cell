...
At \jdbcomment{?} hours post-infection, activation of the IFN reporter was then monitored by flow cytometry using the marker indicated at the bottom of each plot (either a fluorescent protein or antibody staining for the cell-surface LNGFR).
...
For detection of the cell-surface bound LNGFR$\Delta$C, \jdbcomment{cells were stained with?}.
...
Specifically, we infected A549 cells in influenza growth medium, and at \jdbcomment{?} hours post-infection, we trypsinized cells, re-suspended in phosphate-buffered saline (PBS) supplemented with 2\% heat-inactivated fetal bovine serum (FBS), and stained with 10 $\mu$g/ml of H17-L19, a mouse monoclonal antibody previously shown to bind to the HA from the A/WSN/1933 strain of virus~\citep{doud2017complete}.
...
The cells were then infected with this mixture at a dose designed to infect about 30\% of cells \jdbcomment{Is this correct that you targeted 30\%?} (this is about what ended up being the rate of detectable infection in the final sorted and sequenced cells, see \FIG{experiment}D).
\jdbcomment{Were the cells washed after infection?}
Infections were allowed to proceed for 12 hours \jdbcomment{Clarify: this says 12 hours, but other places it says 13 hours. Were they harvested at 12 but the idea is that the whole process added another hour, or were they harvested at 13 hours?}.
