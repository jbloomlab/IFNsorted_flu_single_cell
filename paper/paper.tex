...
To test if the viral defects identified in single IFN+ cells played a causal role in triggering IFN expression, we used reverse genetics to generate bulk stocks of viruses with some of these mutations.
The greatest enrichment of amino-acid substitutions in IFN+ cells was in the PB1 and NS genes (\FIG{mutations}C), so we...
