...
To efficiently identify and enrich rare IFN+ cells, we integrated IFN reporters into the genome of A549 cells (\FIG{IFNrare}B) using lentiviral transduction and expanded cell lines from single clones.
