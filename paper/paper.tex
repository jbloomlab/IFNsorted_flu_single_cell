...
\subsection{Defects in viruses infecting single IFN+ cells often increase IFN induction}
...
The viral feature most strongly associated with IFN induction in single cells was failure to express the NS gene (\FIG{genotypes}, \FIG{mutations}C).
Although it is sometimes possible to use complementing cell lines to generate influenza viruses lacking a specific viral gene~\citep{fujii2003selective,marsh2007specific}, we were unsuccessful in using this approach to generate viruses that lacked NS.
...
We therefore mimicked the effect of absence of NS by creating a mutant virus (which we will term \emph{NS1stop}) that had multiple stop codons early in the NS1 coding sequence.

The single-cell data also showed that amino-acid substitutions in the PB1 and NS genes were associated with IFN induction (\FIG{genotypes}, \FIG{mutations}C), so we also created mutant viruses for each amino-acid substitution found in these genes among IFN+ cells that did not also lack the NS gene.
Overall, there were six \jdbcomment{actually, seven with S704P} such point mutant viruses: PB1-D27N, PB1-G206S, PB1-K279R, PB1-T677A, \jdbcomment{what about PB1-S704P?} NS1-A122V, and NS2-E47G (\FIGSUPP[genotypes]{genotypes_by_ifn}).
