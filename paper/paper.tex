...
We therefore designed experiments to interrogate some of these defects.

We first focused on the PB1 mutations.
Recent research has shown that mutations to the PB2 polymerase subunit of the WSN viral strain can enhance IFN induction by leading to production of aberrant mini viral RNAs (mvRNAs) that trigger RIG-I~\cite{velthuis2018mini}.
To investigate if the PB1 mutations might similarly perturb polymerase activity, we examined their location in a structural model of the polymerase complex (\FIG{PB1}A).
...
Points show three biological replicates; ``n.d.'' indicates not detectable and points in orange were significantly greater than wild type by a two-sided t-test.
(C) Polymerase activity in 293T cells transfected as in panel (B).
...
We speculated that the mutations might reduce polymerase processivity, leading to accumulation of mvRNAs~\cite{velthuis2018mini} or other aberrant short RNA products that might activate the innate immune system~\cite{baum2010preference, tapia2013defective, boergeling2015evidence, dimmock2015cloned}.
