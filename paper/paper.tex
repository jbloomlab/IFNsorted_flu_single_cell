...
But so far, it has been impossible to fully characterize the genetic properties of the virions infecting any given cell, since the conventional techniques of flow cytometry and single-cell RNA-seq only detect if a protein or transcript is present---not whether it has mutations.
