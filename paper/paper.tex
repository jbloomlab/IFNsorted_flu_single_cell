...
We do this by determining the transcriptome and full-length sequences of all viral genes in single influenza-infected cells.
...
Our work shows that the diverse spectrum of defects in influenza virus populations contributes to---but does not completely explain---the heterogeneity in infection outcome and immune activation in single infected cells.
...
We show that viral genetic variation explains some but not all of the cell-to-cell variability in infection outcome.
...
\keywords{influenza virus; interferon; PacBio; single-cell RNAseq; 10X Chromium; NS1; PB1; mini viral RNA; mvRNA; heterogeneity}
