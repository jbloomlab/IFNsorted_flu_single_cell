...
{\bf (C)}
Frequency of IFN induction upon infection with the influenza virus stocks used in the single-cell studies in this paper as quantified using the IFN reporter cell line (see \FIGSUPP[IFNrare]{flow} for details).
The plot also shows uninfected cells as a negative control, and cells infected with saturating amounts of the Cantell strain of Sendai virus~\citep{strahle2006sendai} as a positive control.
