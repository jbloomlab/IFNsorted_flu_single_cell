...
Viral defects also associated with IFN induction, with cells infected by full wildtype virions turning IFN+ less often than cells infected by incomplete or mutated virions (\FIG{mutations}B).
...
\FIG{validation} shows that five of the eight mutant viral stocks induced IFN more frequently than wildtype.
The strongest IFN induction was by the NS1stop virus, but the PB1 internal deletion and three of the point-mutant viruses (PB1-D27N, PB1-T677A, and NS1-A122V) also induced significantly more IFN than wildtype.
...
For instance, our single-cell experiment used a ``wildtype'' viral stock, but most IFN+ cells (31 of 40) still had viral defects (\FIGSUPP[genotypes]{genotypes_by_ifn}). 
