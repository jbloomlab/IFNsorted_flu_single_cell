...
Viral defects are also associated with IFN induction, with cells infected by full wild-type virions expressing IFN less often than cells infected by incomplete or mutated virions (\FIG{mutations}B).
